<?php
ob_start();
session_start();//iniciando a sessção e protegendo.
if(!isset($_SESSION['usuariosy']) && (!isset($_SESSION['senhasy']))){
	...
	$usuarioLogado = $_SESSION['usuariosy'];
	$senhaLogado = $_SESSION['senhasy'];
...
<script src="js/jquery.maskedinput.js" type="text/javascript"></script><meta http-equiv="Content-Type" content="text/html; charset=utf-8">